...
var $author$project$Main$Algos = function (a) {
	return {$: 'Algos', a: a};
};
var $author$project$Main$Error404 = function (a) {
	return {$: 'Error404', a: a};
};
...
var $author$project$Main$urlParser = $elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			$author$project$Main$Algos,
			A2(
				$elm$url$Url$Parser$slash,
				$elm$url$Url$Parser$s('algos'),
				$elm$url$Url$Parser$string)),
			A2($elm$url$Url$Parser$map, $author$project$Main$Error404, $elm$url$Url$Parser$string)
		]));
var $author$project$Main$init = F3(
	function (_v0, url, key) {
		return _Utils_Tuple2(
			{
				navKey: key,
				route: A2($elm$url$Url$Parser$parse, $author$project$Main$urlParser, url),
				url: url
			},
...
var $author$project$Main$navItem = function (path) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Main$navItem('/'),
						$author$project$Main$navItem('/algos/zebra'),
						$author$project$Main$navItem('/algos/double-linked-list-search'),
						$author$project$Main$navItem('/algos/quick-sort'),
						$author$project$Main$navItem('/algos/graph-path-finding')
					]))
			]),
